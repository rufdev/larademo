...
class AssetController extends Controller
{
    ...
    public function index(Request $request)
    {
        $assets = AssetResource::collection(
            Asset::with(['category', 'location', 'manufacturer', 'assignedTo'])
                ->orderBy('name', 'asc')
                ->paginate($request->query('per_page', 10))
        );

         // Fetch master file values for dropdowns
    ...
    public function store(StoreAssetRequest $request)
    {
        ...
        return response()->json([
            ...
            'asset' => new AssetResource($asset) // Optionally return the created asset data
    ...
    public function update(UpdateAssetRequest $request, Asset $asset)
    {
        ...
        return response()->json([
            ...
            'asset' => new AssetResource($asset->fresh()) // Return the fresh, updated asset data
